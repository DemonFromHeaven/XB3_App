...
//
//    /**
//     * Create a new adapter, given a set of restaurants
//     * @param context The application context
//     * @param restaurants The restaurants to use in the list
//     */
//    RestaurantAdapter(Context context, Restaurant[] restaurants) {
//        super(context, R.layout.listviewrow_custom, restaurants);
//        data = restaurants;
//
//        // Keeps track of the state of the check boxes
//        isCheckedArray = new boolean[restaurants.length];
